const CACHE = 'busca-preco-nh-v17-approved-banner'
const SHELL = ['/', '/style.css', '/assets/banner-encartes-aprovado.png', '/assets/busca-preco-logo.svg', '/app.js', '/manifest.webmanifest', '/icons/icon-192.png', '/icons/icon-512.png']
